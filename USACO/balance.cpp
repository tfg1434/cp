/*
 * 7/13 TCs idk
 * First i was like "let's binary search over the number of 1s
 * moved over" but it's not necessary because we can just try
...
ll solve() {
    ...
    //shove 1 at position n over
    //shove a 1 into position 1
    ll res = abs(p-q);
    ll l = n-1;
    ll j = 0;
    ll cost = 0;
