...
// Thinking
// I failed to realize we should do part of it separately--the CC size part
// Needed to reduce it to "my problem is geting CC sizes" then realise this
// can be done as its own problem. Not enough faith
// can be done as its own problem. Not enough faith
void solve() {
