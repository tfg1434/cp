...
void solve() {
    ...
    ll ans = -1;
    {
        ...
        bool ok = true;
        ll res = 0;
        yy([&](auto rec, ll u, ll p, bool blue=false) -> void {
                if (u == lc) blue = 1;
                if (blue && col[u] == 1) ok = false;
                if (!blue) {
                assert(col[u] > -1);
                ans++;
                }
    ...
    }
    {
        ...
        bool ok = true;
        ll res = 0;
        yy([&](auto rec, ll u, ll p, bool red=false) -> void {
                if (u == lc) red = 1;
                if (red && col[u] == -1) ok = false;
                if (red) {
                assert(col[u] > -1);
                ans++;
                }
