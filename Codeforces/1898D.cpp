...
// Embarassing, couldn't solve this problem. Didn't think of seeing
// them as intervals at all...
// It's logical to think of a correspondence since I can't visualize
// this well
void solve() {
    ll n; re(n);
