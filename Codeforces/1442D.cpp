// had a mistake. went in wrong order for knapsack, allowing each element to be taken many times
// -- elements have weights doesn't mean you can take one multiple times.
