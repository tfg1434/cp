...
// Finding eulerian cycle/path on a multigraph
// IFF condition is overpowered, stupid simple
// dfs lol. Much better to store index of edge in adj list 
