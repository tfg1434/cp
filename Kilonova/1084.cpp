...
ll solve2(ll n, ll r, ll k) {
    if ((k+1) & 1) return mod(k+r, n);
    else return mod(k-r, n);
}
...
signed main() {
    ...
    ll T; re(T);
    ll n, r, k, t; re(n, r, k, t);
    k--; t--;
    if (T == 1) {
        ps(solve(n, r, k));
    } else {
        //where does t go (index)
        ll a = solve2(n, r, t);
        //what is in front of index, what is after index
        ps(solve(n, r, mod(a-1, n)), solve(n, r, mod(a+1, n)));
    }
